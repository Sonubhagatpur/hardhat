...
contract BulletoToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Bulleto.io';
    string private _symbol = 'Bulleto.io';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 2000000 * 10**uint256(_decimals);
