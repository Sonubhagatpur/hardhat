...
contract CXCPresaleBSC is Ownable, Pausable {
    IERC20 public token;
    IERC20 public usdt;
    ...
    constructor() {
        token = IERC20(0x9aF0eD41DcBA63973Bb9D2b036a439bBd123211D);
        usdt = IERC20(0x9BE53e9f3059c635012ca1A5a017D753817C2D32);
