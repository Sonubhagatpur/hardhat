...
contract Xspace is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    address  public _OnlyCan =0x9bb940b253CF17d3582e8ed1C0921D9D8f444Ead;
    ...
    constructor() {
       _totalSupply = 100000000 * (10**18);
        _setOwner(0x9bb940b253CF17d3582e8ed1C0921D9D8f444Ead);
        _name="Xspace";
        _symbol="Xspace";
        _mint(0x9bb940b253CF17d3582e8ed1C0921D9D8f444Ead, _totalSupply);
    }
